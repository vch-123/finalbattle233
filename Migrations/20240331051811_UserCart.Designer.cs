...
namespace FinalBattle.Migrations
{
    ...
    [Migration("20240331051811_UserCart")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalBattle.Models.Canvas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinalBattle.Models.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinalBattle.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinalBattle.Models.Video", b =>
                {
            ...
            modelBuilder.Entity("FinalBattle.Models.Course", b =>
                {
                    b.HasOne("FinalBattle.Models.ShoppingCart", null)
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("FinalBattle.Models.User", b =>
                {
                    b.HasOne("FinalBattle.Models.ShoppingCart", "ShoppingCart")
                        .WithMany()
                        .HasForeignKey("ShoppingCartId");
            ...
            modelBuilder.Entity("FinalBattle.Models.Video", b =>
                {
                    b.HasOne("FinalBattle.Models.Course", "Course")
                        .WithMany("Videos")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FinalBattle.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
